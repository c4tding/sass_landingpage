...
const Download = () => {
    return (
        <section>
            <Element name="download" className='bg-g7 relative pb-32 pt-24 max-lg:pb-24 max-md:py-16'>
                <div className="container">
                    <div className="flex items-center">
                        <div className='relative mr-6 flex-540 max-xl:flex-280 max-lg:flex-256 max-md:flex-100'>
                            ...
                            <p className='text-body-1 leading-body-1 mb-10 max-w-md'>
                    ...
                    <ul className='mt-24 flex justify-center max-lg:hidden'>
                        {logos.map(({ id, url, height, title }) => (
                            <li key={id} className='mx-10'>
                                <img src={url} alt={title} height={height} />
                            </li>
                        ))}
                    </ul>
                </div>
