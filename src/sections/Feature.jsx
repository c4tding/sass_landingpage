        ...
        <section>
            <Element name="features">
                <div className="container">
                    <div className="relative flex md:flex-wrap flex-nowrap border-2 border-s3 rounded-7xl md:overflow-hidden max-md:flex-col feature-after md:bg-g7 max-md:border-none max-md:rounded-none max-md:gap-3">
                        {features.map(({ id, icon, caption, title, text, button }) => (
                            <div key={id} className="relative z-2 md:px-10 px-5 md:pb-10 pb-5 flex-50 max-md:border-2 max-md:border-s3 max-md:rounded-3xl max-md:flex-320">
                                ...
                                <h2 className="max-w-400 mb-7 text-h3 font-h3 leading-h3 tracking-h3 text-p4 max-md:mb-6 max-md:text-h5 max-md:font-h5 max-md:leading-h5" >{title}</h2>
                                <p className="mb-11 text-body-1 leading-body-1 max-md:mb-8 max-md:text-body-3 max-md:leading-body-3 max-md:tracking-body-3">{text}</p>
