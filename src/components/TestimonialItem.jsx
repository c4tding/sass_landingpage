...
const TestimonialItem = ({ item, containerClassName }) => {
    return (
        ...
        >
            <blockquote className="text-h6 leading-h6 font-h6 mb-8 text-p4">{item.comment}</blockquote>
            ...
            <div className="flex items-center max-xl:-mr-8">
                ...
                <div>
                    <h4 className="text-body-2 font-body-2 leading-body-2 mb-0.5 text-p1">{item.name}</h4>
